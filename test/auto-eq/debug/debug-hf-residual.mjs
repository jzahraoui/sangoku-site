...
const measuredData = parseREWFile('./test/auto-eq/exemple4/SBRavg.txt');
const targetData = parseREWFile('./test/auto-eq/exemple4/Target SBRavg.txt');
const rewFilters = parseActiveRewFilters('./test/auto-eq/exemple4/rew-auto-eq.txt');
