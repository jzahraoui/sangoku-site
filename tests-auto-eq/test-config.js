...
export const TEST_EXAMPLES = {
  exemple1: {
    basePath: './tests-auto-eq/exemple1',
    measured: './tests-auto-eq/exemple1/FRavg.txt',
    target: './tests-auto-eq/exemple1/Target FRavg.txt',
    rewFilters: './tests-auto-eq/exemple1/REW_Filters.txt',
  },
  exemple2: {
    basePath: './tests-auto-eq/exemple2',
    measured: './tests-auto-eq/exemple2/FRavg.txt',
    target: './tests-auto-eq/exemple2/Target FRavg.txt',
    rewFilters: './tests-auto-eq/exemple2/REW_Filters.txt',
  },
  exemple3: {
    basePath: './tests-auto-eq/exemple3',
    measured: './tests-auto-eq/exemple3/FRavg.txt',
    target: './tests-auto-eq/exemple3/Target FRavg.txt',
    rewFilters: './tests-auto-eq/exemple3/REW_Filters.txt',
  },
  exemple4: {
    basePath: './tests-auto-eq/exemple4',
    measured: './tests-auto-eq/exemple4/FRavg.txt',
    target: './tests-auto-eq/exemple4/Target FRavg.txt',
    rewFilters: './tests-auto-eq/exemple4/REW_Filters.txt',
  },
};
