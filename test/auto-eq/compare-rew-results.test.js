...
const rewFilters = parseREWFilters('./test/auto-eq/exemple1/rew-auto-eq.txt');
...
const measuredData = parseREWMeasurement('./test/auto-eq/exemple1/FRavg.txt');
const targetData = parseREWMeasurement('./test/auto-eq/exemple1/Target FRavg.txt');
