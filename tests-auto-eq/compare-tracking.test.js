...
const rewCorrected = parseREWFile('./tests-auto-eq/exemple1/EQ FRavg.txt');
const ourCorrected = parseREWFile('./test-results/FRavg_Equalized.txt');
const target = parseREWFile('./tests-auto-eq/exemple1/Target FRavg.txt');
const original = parseREWFile('./tests-auto-eq/exemple1/FRavg.txt');
